...
inline point3 random_point() {
    ...
    double randX = 2.5f + static_cast<double>(rand()) / (RAND_MAX / (4.0f - 2.5f));
    double randY = 3.2f + static_cast<double>(rand()) / (RAND_MAX / (3.6f - 3.2f));
    double randZ = -3.0f + static_cast<double>(rand()) / (RAND_MAX / (3.0f - (-3.0f)));
